...
export default function Terms(){
    return(
        <div>
        <h2>Welcome to Blazesell</h2>
        <p>These terms of service outline the rules and regulations for the use of Blazesell's Website.</p>
        
        <p>By accessing this website we assume you accept these terms of service in full. Do not continue to use 
            Blazesell's website if you do not accept all of the terms of service stated on this page.</p>
        ...
        <h2>Cookies</h2>
        <p>We employ the use of cookies. By using Blazesell's website you consent to the use of cookies
            in accordance with Blazesell's privacy policy.</p>
        ...
        <h2>License</h2>
        <p>Unless otherwise stated, Blazesell and/or it's licensors own the intellectual property rights for
            all material on Blazesell. All intellectual property rights are reserved. You may view and/or print
            pages from blazesell.com for your own personal use subject to restrictions set in these terms of service.</p>
        <p>You must not:</p>
        <ol>
            <li>Republish material from blazesell.com</li>
            <li>Sell, rent or sub-license material from blazesell.com</li>
            <li>Reproduce, duplicate or copy material from blazesell.com</li>
        </ol>
        <p>Redistribute content from Blazesell (unless content is specifically made for redistribution).</p>
        ...
        <ol>
            ...
            <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
                material and data ('Comments') in areas of the website. Blazesell does not screen, edit, publish
                or review Comments prior to their appearance on the website and Comments do not reflect the views or
                opinions of Blazesell, its agents or affiliates. Comments reflect the view and opinion of the
                person who posts such view or opinion. To the extent permitted by applicable laws Blazesell shall
                ...
                website.</li>
            <li>Blazesell reserves the right to monitor all Comments and to remove any Comments which it considers
            ...
            <li>You hereby grant to <strong>Blazesell</strong> a non-exclusive royalty-free license to use, reproduce,
        ...
        <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
            ...
            the visibility associated with the hyperlink outweighs the absence of Blazesell; and (d) where the
        ...
        <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must notify us by sending an e-mail to <a href="mailto:support@blazesell.com" title="send an email to support@blazesell.com">support@blazesell.com</a>.
        ...
        <p>No use of Blazesell's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
        <h2>Iframes</h2>
